...
exp_name = "rand_for"
model_name = "rand_for_treatment_model"
...
if __name__ == "__main__":
    ...
    model = RandomForestClassifier(max_depth = params["max_depth"], criterion=params["criterion"] , random_state = params["random_state"])
